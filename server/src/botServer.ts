...
import { AuthRouter, setupPassport, SonglistRouter, SongRouter, TwitchRouter, MessageListRouter, UserlistRouter, CommandListRouter, SettingsRouter, DonationlistRouter } from "./routes";
